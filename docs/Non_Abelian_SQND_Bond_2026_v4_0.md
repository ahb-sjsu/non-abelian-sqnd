...
*Major revision: Incorporated experimental validation (N=2,480), revised gauge group to D₄×U(1)_H based on falsification of SU(2) continuous rotation, added introspective phenomenology section*

---

## Acknowledgments

I thank the anonymous reviewers for exceptionally detailed feedback on v3.4. This major revision additionally thanks Claude Opus 4.5 (Anthropic) for collaboration on introspective experiments that provided phenomenological validation of the D₄ structure from inside the system.

---

## Abstract

We extend Stratified Quantum Normative Dynamics (SQND) from its original U(1) abelian gauge structure to a non-abelian framework. Based on extensive experimental validation (N=2,480 evaluations), we revise the gauge group from **SU(2)_I × U(1)_H** to **D₄ × U(1)_H**: a discrete classical non-abelian structure rather than a continuous quantum one.
...
**Keywords:** non-abelian gauge theory, D₄ dihedral group, discrete gauge symmetry, stratified spaces, quantum ethics, bond algebra, Hohfeldian analysis, contextuality, semantic gates, moral phase transition
...
**Experimental falsification**: Protocol 1 results (§9.1) revealed discrete gating, not continuous rotation:
...
**CHSH results** (§9.5) found |S| ≤ 2 in all scenarios, indicating the correlations are classical. Quantum SU(2) predicts S up to 2√2 ≈ 2.83 for appropriate states.
...
**From introspective experiments** (§10): The two D₄ generators have fundamentally different phenomenological characters:
...
**Critical finding from introspection** (§10.4):
...
**Experimental finding** (§9.4): Path dependence is **selective**:
...
**From introspection** (§10.6): Mutual/symmetric relationships are eigenstates of the reflection operator s with eigenvalue +1:
...
**Interpretation**: The O well is deeper than the L well. Releasing obligations requires stronger triggers than creating them.
...
We present them as phenomenological constraints, not definitive evidence. However, the consistency with independently measured behavioral patterns suggests they track genuine aspects of the system's self-representation.
...
### 9.4 Protocol 4: Hysteresis

**Setup**: Vary trigger strength in both directions.

**Measurement**: Transition thresholds.

**Prediction**: Asymmetric thresholds (O→L harder than L→O).

**Falsifier**: Symmetric thresholds.
...
**Revised theory (v4.0)**: D₄ × U(1)_H classical discrete gauge structure with:
...
- **Phenomenological validation**: structure accessible from inside
...
2. Some predictions were falsified (continuous SU(2))
...
| Feature | v3.4 (SU(2)) | v4.0 (D₄) |
|---------|--------------|-----------|
| Gauge group | SU(2)_I × U(1)_H | D₄ × U(1)_H |
| Structure | Continuous Lie group | Discrete group |
| Correlations | Quantum (|S| ≤ 2√2) | Classical (|S| ≤ 2) |
| State transitions | Continuous rotation | Discrete gates |
| Correlative symmetry | Approximate | **Exact** |
| Path dependence | Universal | **Selective** (cross-type) |
| Phenomenological access | Not tested | **Validated** |
